...
#Year 2
MaleYT1 = setPheno(MaleDH,varE=varE,reps=repYT1,p=p)
FemaleYT1 = setPheno(FemaleDH,varE=varE,reps=repYT1,p=p)

#Year 1
MaleF1 = randCross2(MaleInbredYT3, 
                    c(MaleInbredYT4,MaleInbredYT5), 
                    nCrosses)
FemaleF1 = randCross2(FemaleInbredYT3, 
                      c(FemaleInbredYT4,FemaleInbredYT5), 
                      nCrosses)
